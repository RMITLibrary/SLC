...
var data = [
  {
    ...
    'answer': 'F',
    'feedback-F': 'Correct. The amount of work you need to do may vary through the semester. You will need to develop good time management skills to balance your study and personal life. Do this by setting goals and prioritise your study.',
  ...
  {
    'secNum': 0,
    'statement': 'My lecturers and tutors will tell me what I need to do all through the semester.',
    'answer': 'F',
    'feedback-F': 'Correct. Your teachers will guide you throughout your studies but you will need to take responsibility for your own learning. Independent learning is an important tertiary skill.',
  ...
  },
  {
    ...
    'answer': 'T',
    'feedback-F': 'Highlighting may not be enough. Learn actively by writing down what you understand (from your lecture or readings) in your own words. If you can express the ideas yourself, you have understood them.',
    'feedback-T': 'Correct. Highlighting may not be enough. Learn actively by writing down what you understand (from your lecture or readings) in your own words. If you can express the ideas yourself, you have understood them.',
    'feedback-N': 'Highlighting may not be enough. Learn actively by writing down what you understand (from your lecture or readings) in your own words. If you can express the ideas yourself, you have understood them.',
    'chosen': null,
  ...
  },
  {
    ...
    'answer': 'T',
    'feedback-F': 'You need to learn strategies for making effective notes. Focus on key concepts and ideas to guide your understanding. Don\'t try to take notes on everything.',
  ...
  },
  {
    ...
    'answer': 'F',
    'feedback-F': 'Correct. Use active learning strategies throughout the semester. Mind mapping, forming study groups and revising your notes are all good strategies.',
  ...
  {
    'secNum': 0,
    'statement': 'My RMIT classes will be different to the ones I had in high school.',
    'answer': 'T',
    'feedback-F': 'There are many different types of classes at RMIT and they may be different from high school (e.g. lectures, tutorials, practicals, studios, etc.).',
    'feedback-T': 'Correct. There are many different types of classes at RMIT and they may be different from high school (e.g. lectures, tutorials, practicals, studios, etc.).',
  ...
  {
    'secNum': 0,
    'statement': 'There are RMIT services to help me with my studies.',
    'answer': 'T',
    ...
    'feedback-T': 'RMIT has face-to-face and online support available to all students. Use these resources and services as soon as possible to maximise study success.',
  ...
  {
    'secNum': 0,
    'statement': 'Attending classes is not so important because teachers put the information online.',
    'answer': 'F',
    'feedback-F': 'Correct. It is very important to attend classes. You need to ask questions, join discussions and talk about important course content. This is also a great way to interact and collaborate with other students.',
    'feedback-T': 'It is very important to attend classes. You need to ask questions, join discussions and talk about important course content. This is also a great way to interact and collaborate with other students.',
    'feedback-N': 'It is very important to attend classes. You need to ask questions, join discussions and talk about important course content. This is also a great way to interact and collaborate with other students.',
    'chosen': null,
  ...
  {
    'secNum': 1,
    'statement': 'I\'ll need to read all my university texts very carefully.',
    'answer': 'F',
    'feedback-F': 'Correct. Good readers at university use reading strategies such as surveying, skimming, and scanning to decide whether they need to read in detail.',
    'feedback-T': 'It depends. Good readers at university use reading strategies such as surveying, skimming, and scanning to decide whether they need to read in detail.',
    'feedback-N': 'It depends. Good readers at university use reading strategies such as surveying, skimming, and scanning to decide whether they need to read in detail.',
    'chosen': null,
    'image': './img/graphics/10_magnified_book_385x215.png'
  },
  {
    'secNum': 1,
    'statement': 'I need to read everything that is on my course reading list.',
    'answer': 'F',
    'feedback-F': 'Correct. Manage your reading load by only reading things that are relevant to the specific question or topic. Don\'t waste time by trying to read every \'recommended\' text.',
