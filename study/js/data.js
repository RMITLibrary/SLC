...
var data = [
  {
    'secNum': 0,
    'statement': 'My workload, including assignments, will be evenly spaced throughout the course.',
    'answer': 'F',
  ...
  {
    'secNum': 0,
    'statement': 'My teachers will tell me what I need to do throughout the semester.',
    'answer': 'F',
    'feedback-F': 'Your teachers will guide you throughout your studies but you will need to take responsibility for your own learning. Independent learning is an important tertiary skill.',
  ...
  },
  {
    ...
    'answer': 'F',
    'feedback-F': 'It\'s important to get an overview of learning material first to assess whether you need to read in detail. Good readers use reading strategies such as surveying, skimming and scanning.',
  ...
  },
  {
    ...
    'answer': 'F',
    'feedback-F': 'Don\'t waste time by trying to read every \'recommended\' text completely. Manage your reading load by only reading things that are relevant to a specific question or topic. ',
  ...
  {
    'secNum': 2,
    'statement': 'Writing at RMIT is similar to the writing I did at high school.',
    'answer': 'F',
    'feedback-F': 'Writing at tertiary level requires a more formal style and structure. You will learn different writing conventions throughout your studies.',
    'feedback-T': 'Writing at tertiary level requires a formal style and structure. You will learn different writing conventions throughout your studies.',
    'feedback-N': 'Writing at tertiary level requires a formal style and structure. You will learn different writing conventions throughout your studies.',
    'chosen': null,
  ...
  {
    'secNum': 2,
    'statement': 'Because I learnt how to write essays at school, I\'ll know how to write at a tertiary level.',
    'answer': 'F', 
    'feedback-F': 'You may need to learn to write many different type of assessment tasks. Essays, reports, case studies, reflections and group assignments are some common assessment tasks.',
    'feedback-T': 'You may need to learn to write many different type of assessment tasks. Essays, reports, case studies, reflections and group assignments are some common assessment tasks.',
    'feedback-N': 'You may need to learn to write many different type of assessment tasks. Essays, reports, case studies, reflections and group assignments are some common assessment tasks..',
    'chosen': null,
    'image': './img/graphics/14_writing_notes_375x245.png'
  },
  {
    'secNum': 2,
    'statement': 'If I use someone\'s ideas, data, or images in my written work, I need to acknowledge where they came from.',
    'answer': 'T',
    'feedback-F': 'You must acknowledge all your sources in your assessment. This gives your work credibility and shows you\'ve done your research.',
    'feedback-T': 'Correct. You must acknowledge all your sources in your assessment. This gives your work credibility and shows you\'ve done your research.',
    'feedback-N': 'You must acknowledge all your sources in your assessment. This gives your work credibility and shows you\'ve done your research.',
    'chosen': null,
    'image': './img/graphics/15_idea_sources_285x220.png'
  },
  {
    'secNum': 3,
    'statement': 'Asking questions in class will help you learn.',
    'answer': 'T',
    'feedback-T': 'Correct. Asking questions is a great way to learn. Whatever you want to ask, there are probably many other students wondering the same thing.',
  ...
  },
  {
    ...
    'answer': 'F',
    'feedback-F': 'Correct. Thinking critically is about analysing ideas to identify their strengths and weaknesses.',
    'feedback-T': 'Not quite. Thinking critically is about analysing and evaluating ideas to identify their strengths and weaknesses.',
    'feedback-N': 'Thinking critically is about analysing and evaluating ideas to identify their strengths and weaknesses.',
    'chosen': null,
    'image': './img/graphics/17_lightbulb_180x255.gif'
  },
  {
    'secNum': 3,
    'statement': 'If something is in a textbook or journal, it must be right.',
    'answer': 'F',
    'feedback-F': 'Correct. You need review and evaluate your readings. Check the publication, date, author and audience to decide the value of the information for your purpose ',
    'feedback-T': 'Not necessarily. You need review and evaluat eyour readings. You need to check the publication, date, author and audience to decide the value of the information for your purpose.',
    'feedback-N': 'Not necessarily.  You need review and evaluate your readings. You need to check the publication, date, author and audience to decide the value of the information for your purpose.',
    'chosen': null,
    'image': './img/graphics/18_published_book_515_220.png'
  },
  {
    'secNum': 3,
    'statement': 'Lecturers and tutors are interested in my ideas and my ability to show I\'ve learned the course material.',
    'answer': 'T',
    'feedback-F': 'Teaching staff use assessment to know that you understand a topic. You can show this by discussing and building on other researchers\' ideas to develop your own analysis.',
    'feedback-T': 'Correct. Teaching staff use assessment to know that you understand a topic. You can show this by discussing and building on other researchers\' ideas to develop your own analysis.',
    'feedback-N': 'Teaching staff use assessment to know that you understand a topic. You can show this by discussing and building on other researchers\' ideas to develop your own analysis.',
    'chosen': null,
  ...
  },
  {
    ...
    'answer': 'T',
    'feedback-F': 'Critical thinking is highly prized by employers in all industries (along with problem-solving and communication skills).',
